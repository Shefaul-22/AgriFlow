...
export default function ActiveDelivery() {
  const [activeOrder, setActiveOrder] =
    useState<ActiveDeliveryType | null>(null);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50/30">
        <div className="text-center">
          <div className="w-14 h-14 border-4 border-green-200 border-t-green-600 rounded-full animate-spin mx-auto mb-5"></div>
          ...
          <p className="text-sm text-gray-400 mt-2">
            Fetching live shipment details.
          </p>
        </div>
      </div>
    );
  ...
  if (!activeOrder) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50/30 p-6">
        <div className="bg-white border border-gray-100 rounded-[2.5rem] shadow-xl p-12 max-w-lg w-full text-center">
          ...
          <h2 className="text-3xl font-black text-gray-700 tracking-tight">
            No Active Delivery
          </h2>

          <p className="text-gray-400 mt-3 text-sm leading-relaxed">
            You currently do not have any ongoing shipment assigned.
            Accept a new order to begin delivery operations.
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-10">
          <h1 className="text-4xl font-bold flex items-center tracking-tight text-green-600 gap-2">
            ...
            Active <span className="text-yellow-600">.</span> Delivery
          </h1>
        ...
        >
          ...
          <div className="bg-green-600 p-6 text-white flex justify-between items-center">
            ...
            <span className="text-xs font-bold bg-green-700/50 px-3 py-1 rounded-lg">
              ID: {activeOrder.trackingId}
            </span>
          </div>
          ...
          <div className="p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <label className="text-[10px] font-black uppercase tracking-widest text-yellow-600 ml-1">
                    Customer Details
                  </label>
